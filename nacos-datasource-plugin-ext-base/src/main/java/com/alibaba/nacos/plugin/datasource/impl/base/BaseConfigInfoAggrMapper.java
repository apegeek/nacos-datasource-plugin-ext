...
public class BaseConfigInfoAggrMapper extends ConfigInfoAggrMapperByMySql {
    ...
    public MapperResult findConfigInfoAggrByPageFetchRows(MapperContext context) {
        ...
        String sql = databaseDialect.getLimitPageSqlWithOffset("SELECT data_id,group_id,tenant_id,datum_id,app_name,content FROM config_info_aggr WHERE data_id= ? AND "
                        + "group_id= ? AND tenant_id= ? ORDER BY datum_id", context.getStartRow(), context.getPageSize());
